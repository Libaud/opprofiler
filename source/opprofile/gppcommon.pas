...
procedure KillFile(fName: String);
begin
  if FileExistsUTF8(fName) { *Converti depuis FileExists* } then begin
    SetFileAttributes(PChar(fName), 0);
    DeleteFileUTF8(fName); { *Converti depuis DeleteFile* }
  end;
end; { KillFile }
...
begin
  ...
  then Result := WAIT_FAILED
    ...
    FileClose(ProcessInfo.hProcess); { *Converti depuis CloseHandle* }
    FileClose(ProcessInfo.hThread); { *Converti depuis CloseHandle* }
  end;
